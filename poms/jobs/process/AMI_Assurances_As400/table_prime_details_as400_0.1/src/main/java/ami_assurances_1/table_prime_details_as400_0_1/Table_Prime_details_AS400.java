...
package ami_assurances_1.table_prime_details_as400_0_1;
...
/**
 * Job: Table_Prime_details_AS400 Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Table_Prime_details_AS400 implements TalendJob {
	...
	private final String jobName = "Table_Prime_details_AS400";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Table_Prime_details_AS400.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Table_Prime_details_AS400.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_AMI_ASSURANCES_1_Table_Prime_details_AS400 = new byte[0];
		static byte[] commonByteArray_AMI_ASSURANCES_1_Table_Prime_details_AS400 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_AMI_ASSURANCES_1_Table_Prime_details_AS400.length) {
					if (length < 1024 && commonByteArray_AMI_ASSURANCES_1_Table_Prime_details_AS400.length == 0) {
						commonByteArray_AMI_ASSURANCES_1_Table_Prime_details_AS400 = new byte[1024];
					} else {
						commonByteArray_AMI_ASSURANCES_1_Table_Prime_details_AS400 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_AMI_ASSURANCES_1_Table_Prime_details_AS400, 0, length);
				strReturn = new String(commonByteArray_AMI_ASSURANCES_1_Table_Prime_details_AS400, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_AMI_ASSURANCES_1_Table_Prime_details_AS400) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_1 = "Prime_Details_AS400";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:qGTJQj0EwYpfvG+5lyEYbBlCT1ojbj2iObGbTjEx1Jsn/kg=");
				...
				String insert_tDBOutput_1 = "INSERT INTO " + "Prime_Details_AS400"
						+ " (NUMQUITT,CODGRNT,MNTPRGRNT,LIBGRNSIN) VALUES (?,?,?,?)";
				...
				class KeyStruct_tUniqRow_1 {
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime * result + (int) this.MNTPRGRNT;
					...
					public boolean equals(Object obj) {
						...
						if (this.MNTPRGRNT != other.MNTPRGRNT)
							return false;
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:oUjoX0ERPjapxrVekBX0dEhgcxfNVicGnqgGjmT47jS5eHs=");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row5HashKey.CODGRNT = row1.CODGRNT;
						...
						if (tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row5.CODGRNT = '" +
							// row5HashKey.CODGRNT + "'");
						} // G 071
...
// Start of branch "row2"
						if (row2 != null) {
							...
							row3 = null;
							finder_tUniqRow_1.NUMQUITT = row2.NUMQUITT;
							finder_tUniqRow_1.CODGRNT = row2.CODGRNT;
							finder_tUniqRow_1.MNTPRGRNT = row2.MNTPRGRNT;
							finder_tUniqRow_1.hashCodeDirty = true;
							if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
								KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

								new_tUniqRow_1.NUMQUITT = row2.NUMQUITT;
								new_tUniqRow_1.CODGRNT = row2.CODGRNT;
								new_tUniqRow_1.MNTPRGRNT = row2.MNTPRGRNT;
								...
								row3.NUMQUITT = row2.NUMQUITT;
								row3.CODGRNT = row2.CODGRNT;
								row3.MNTPRGRNT = row2.MNTPRGRNT;
...
// Start of branch "row3"
							if (row3 != null) {
								...
								pstmt_tDBOutput_1.setBigDecimal(1, row3.NUMQUITT);

								if (row3.CODGRNT == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, row3.CODGRNT);
								}

								pstmt_tDBOutput_1.setFloat(3, row3.MNTPRGRNT);

								if (row3.LIBGRNSIN == null) {
									pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(4, row3.LIBGRNSIN);
								}
...
// ###############################      
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_1 - inputs:(row1,row5) outputs:(row2)
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:lDXAqI0zC3ZkHC2QWUWGDHnzOAoefco6I94nvfuiY8f7x08=");
	...
	public static void main(String[] args) {
		final Table_Prime_details_AS400 Table_Prime_details_AS400Class = new Table_Prime_details_AS400();

		int exitCode = Table_Prime_details_AS400Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Table_Prime_details_AS400.class.getClassLoader().getResourceAsStream(
					"ami_assurances_1/table_prime_details_as400_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Table_Prime_details_AS400.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Table_Prime_details_AS400");
		}
...
/************************************************************************************************
 * 87544 characters generated by Talend Open Studio for Data Integration on the
 * 5 septembre 2022 à 13:38:18 GMT+01:00
 ************************************************************************************************/