...
package ami_assurances_1.copy_of_table_sinistre_as400_0_1;
...
/**
 * Job: Copy_of_Table_Sinistre_AS400 Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Copy_of_Table_Sinistre_AS400 implements TalendJob {
	...
	private final String jobName = "Copy_of_Table_Sinistre_AS400";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Copy_of_Table_Sinistre_AS400.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Copy_of_Table_Sinistre_AS400.this,
	...
	public static class row5Struct implements routines.system.IPersistableComparableLookupRow<row5Struct> {
		final static byte[] commonByteArrayLock_AMI_ASSURANCES_1_Copy_of_Table_Sinistre_AS400 = new byte[0];
		static byte[] commonByteArray_AMI_ASSURANCES_1_Copy_of_Table_Sinistre_AS400 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_AMI_ASSURANCES_1_Copy_of_Table_Sinistre_AS400.length) {
					if (length < 1024 && commonByteArray_AMI_ASSURANCES_1_Copy_of_Table_Sinistre_AS400.length == 0) {
						commonByteArray_AMI_ASSURANCES_1_Copy_of_Table_Sinistre_AS400 = new byte[1024];
					} else {
						commonByteArray_AMI_ASSURANCES_1_Copy_of_Table_Sinistre_AS400 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_AMI_ASSURANCES_1_Copy_of_Table_Sinistre_AS400, 0, length);
				strReturn = new String(commonByteArray_AMI_ASSURANCES_1_Copy_of_Table_Sinistre_AS400, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readKeysData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_AMI_ASSURANCES_1_Copy_of_Table_Sinistre_AS400) {
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:2Jv4qIGy2zz8cDH5oRq9hZJMb2dQSl2u1eu6V9YOlr7wwfQ=");
...
///////////////////////    			
				...
				String tableName_tDBOutput_1 = "SinistresAS400";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:JrVeGLx+Yw5nUnn5sWN5Txnpccwwox1p4DLavXJAKt5ToHA=");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equalsIgnoreCase("SinistresAS400")) {
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE " + tableName_tDBOutput_1
							+ "(NUMSNT VARCHAR(15)   not null ,CAUSESINI VARCHAR(2)   not null ,NATSINI VARCHAR(1)   not null ,NUMCNT VARCHAR(15)   not null ,NUMAVT NUMERIC(3,0)   not null ,NUMMAJ NUMERIC(3,0)   not null ,NATINT VARCHAR(2)   not null ,IDINT VARCHAR(10)   not null ,CODPROD VARCHAR(3)   not null ,CODFORMU VARCHAR(2)   not null ,CODE_ETAT VARCHAR(1)   not null ,DATETASIN DATE  not null ,CPOSTSINI VARCHAR(5)   not null ,CITESINI VARCHAR(30)   not null ,REGSINI VARCHAR(20)  ,GOUVSINI VARCHAR(12)  ,IDCAMTIER NUMERIC(10,0)   not null ,CAS_IDA NUMERIC(2,0)   not null ,DTOUVSNT DATE  not null ,DTCLTSNT DATE ,MNTPROVIS NUMERIC(12,3)   not null ,MNTPAIGRN NUMERIC(12,3)   not null ,MNTAGGRAV NUMERIC(12,3)   not null ,MNTAMELIO NUMERIC(12,3)   not null ,MNTTOTAL NUMERIC(12,3)   not null ,MNTTOTNET NUMERIC(12,3)   not null ,primary key(NUMSNT))");
				}
				String insert_tDBOutput_1 = "INSERT INTO " + "SinistresAS400"
						+ " (NUMSNT,CAUSESINI,NATSINI,NUMCNT,NUMAVT,NUMMAJ,NATINT,IDINT,CODPROD,CODFORMU,CODE_ETAT,DATETASIN,CPOSTSINI,CITESINI,REGSINI,GOUVSINI,IDCAMTIER,CAS_IDA,DTOUVSNT,DTCLTSNT,MNTPROVIS,MNTPAIGRN,MNTAGGRAV,MNTAMELIO,MNTTOTAL,MNTTOTNET) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:1ZggjwED1r6jK+cfChOQlAA39fbp/FKGYmeTlyC3XZ0/mQ0=");
...
// Start of branch "row4"
								if (row4 != null) {
									...
									if (row4.CODPROD == null) {
										...
										pstmt_tDBOutput_1.setString(9, row4.CODPROD);
									}

									if (row4.CODFORMU == null) {
										pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(10, row4.CODFORMU);
									}

									if (row4.CODE_ETAT == null) {
										pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(11, row4.CODE_ETAT);
									}
									...
									if (row4.CPOSTSINI == null) {
										...
										pstmt_tDBOutput_1.setString(13, row4.CPOSTSINI);
									}

									if (row4.CITESINI == null) {
										pstmt_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(14, row4.CITESINI);
									}

									if (row4.REGSINI == null) {
										pstmt_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(15, row4.REGSINI);
									}

									if (row4.GOUVSINI == null) {
										pstmt_tDBOutput_1.setNull(16, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(16, row4.GOUVSINI);
									}

									pstmt_tDBOutput_1.setFloat(17, row4.IDCAMTIER);

									pstmt_tDBOutput_1.setFloat(18, row4.CAS_IDA);

									if (row4.DTOUVSNT != null) {
										pstmt_tDBOutput_1.setTimestamp(19,
									...
									pstmt_tDBOutput_1.setFloat(21, row4.MNTPROVIS);

									pstmt_tDBOutput_1.setFloat(22, row4.MNTPAIGRN);

									pstmt_tDBOutput_1.setFloat(23, row4.MNTAGGRAV);

									pstmt_tDBOutput_1.setFloat(24, row4.MNTAMELIO);

									pstmt_tDBOutput_1.setFloat(25, row4.MNTTOTAL);

									pstmt_tDBOutput_1.setFloat(26, row4.MNTTOTNET);
...
///////////////////////    			
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:XjCCKoAFlOD1CCjW94t5cF2/HyiO7OOo7zAUzdmp8AJ7s7g=");
	...
	public static void main(String[] args) {
		final Copy_of_Table_Sinistre_AS400 Copy_of_Table_Sinistre_AS400Class = new Copy_of_Table_Sinistre_AS400();

		int exitCode = Copy_of_Table_Sinistre_AS400Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Copy_of_Table_Sinistre_AS400.class.getClassLoader().getResourceAsStream(
					"ami_assurances_1/copy_of_table_sinistre_as400_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Copy_of_Table_Sinistre_AS400.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Copy_of_Table_Sinistre_AS400");
		}
...
/************************************************************************************************
 * 267880 characters generated by Talend Open Studio for Data Integration on the
 * 3 août 2022 à 13:49:34 GMT+01:00
 ************************************************************************************************/