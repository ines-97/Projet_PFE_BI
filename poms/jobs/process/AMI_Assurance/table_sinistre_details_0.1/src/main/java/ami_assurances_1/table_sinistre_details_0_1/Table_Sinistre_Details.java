...
package ami_assurances_1.table_sinistre_details_0_1;
...
/**
 * Job: Table_Sinistre_Details Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Table_Sinistre_Details implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Table_Sinistre_Details";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Table_Sinistre_Details.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Table_Sinistre_Details.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_AMI_ASSURANCES_1_Table_Sinistre_Details = new byte[0];
    static byte[] commonByteArray_AMI_ASSURANCES_1_Table_Sinistre_Details = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AMI_ASSURANCES_1_Table_Sinistre_Details.length) {
				if(length < 1024 && commonByteArray_AMI_ASSURANCES_1_Table_Sinistre_Details.length == 0) {
   					commonByteArray_AMI_ASSURANCES_1_Table_Sinistre_Details = new byte[1024];
				} else {
   					commonByteArray_AMI_ASSURANCES_1_Table_Sinistre_Details = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AMI_ASSURANCES_1_Table_Sinistre_Details, 0, length);
			strReturn = new String(commonByteArray_AMI_ASSURANCES_1_Table_Sinistre_Details, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AMI_ASSURANCES_1_Table_Sinistre_Details) {
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("Sinistre_Details");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("Sinistre_Details");
}
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:CtxeYI9U44vmlhTc38Ql6WThU+Bfr5YhUxiCJPRSQNLu0g2K39RSCg==");
...
int count_tDBOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null, new String[]{"TABLE"})) {
                                    ...
                                    while(rsTable_tDBOutput_1.next()) {
                                        ...
                                        if(table_tDBOutput_1.equals(("Sinistre_Details"))
                                ...
                                try(java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                    stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1 + "\"(\"NUMSNT\" VARCHAR(15)  default ' '  not null ,\"GRNTSINI\" VARCHAR(4)  default ' '  not null ,\"MNTPROVIS\" NUMERIC(12,3)  default 0  not null ,\"MNTPAIGRN\" NUMERIC(12,3)  default 0  not null ,\"MNTTOTAL\" NUMERIC(12,3)  default 0  not null ,\"MNTTOTNET\" NUMERIC(12,3)  default 0  not null ,\"MNTAGGRAV\" NUMERIC(12,3)   not null ,\"MNTAMELIO\" NUMERIC(12,3)   not null ,\"LIBGRNSIN\" VARCHAR(30)  default ' ' )");
                                }
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"NUMSNT\",\"GRNTSINI\",\"MNTPROVIS\",\"MNTPAIGRN\",\"MNTTOTAL\",\"MNTTOTNET\",\"MNTAGGRAV\",\"MNTAMELIO\",\"LIBGRNSIN\") VALUES (?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:P9WaP0oDZZES3N82RxpcPesYcMfX8zVMlpvyERwcbPlaaSU=");
 							...
 							row4Struct row4ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
				           		...
				           		if(tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row4' and it contains more one result from keys :  row4.NUMSNT = '" + row4HashKey.NUMSNT + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row5HashKey.GRNTSINI = row1.GRNTSINI;
				           		...
				           		if(tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row5' and it contains more one result from keys :  row5.CODPROD = '" + row5HashKey.CODPROD + "', row5.CODFORMU = '" + row5HashKey.CODFORMU + "', row5.GRNTSINI = '" + row5HashKey.GRNTSINI + "'");
								} // G 071
...
Var.var1 = StringHandling.EREPLACE(row4.NUMSNT ," ","") ;// ###############################
        // ###############################
        // # Output tables
...
// # Output table : 'row2'
row2_tmp.NUMSNT = Var.var1 ;
row2_tmp.GRNTSINI = row1.GRNTSINI ;
...
new_tUniqRow_1.MNTTOTNET = row2.MNTTOTNET;
	...
	row3 = new row3Struct();
}row3.NUMSNT = row2.NUMSNT;			row3.GRNTSINI = row2.GRNTSINI;			row3.MNTPROVIS = row2.MNTPROVIS;			row3.MNTPAIGRN = row2.MNTPAIGRN;			row3.MNTTOTAL = row2.MNTTOTAL;			row3.MNTTOTNET = row2.MNTTOTNET;			row3.MNTAGGRAV = row2.MNTAGGRAV;			row3.MNTAMELIO = row2.MNTAMELIO;			row3.LIBGRNSIN = row2.LIBGRNSIN;					
...
} else {pstmt_tDBOutput_1.setString(1, row3.NUMSNT);
}

                    if(row3.GRNTSINI == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row3.GRNTSINI);
}
...
} else {pstmt_tDBOutput_1.setString(9, row3.LIBGRNSIN);
}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row4,row5) outputs:(row2)
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:FETj4BBbTzqUoZ8XM7WUM/DqWm39eLVO6DXv4LyBv9dY/l8=");
...
public static class row5Struct implements routines.system.IPersistableComparableLookupRow<row5Struct> {
    ...
    public int compareTo(row5Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.GRNTSINI, other.GRNTSINI);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:WCh0z48IVCDyngQn/2SXZOt4xhQG7BZAsTso5yrlq6KjDHg=");
 ...
 */
    ...
    public static void main(String[] args){
        final Table_Sinistre_Details Table_Sinistre_DetailsClass = new Table_Sinistre_Details();

        int exitCode = Table_Sinistre_DetailsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Table_Sinistre_Details.class.getClassLoader().getResourceAsStream("ami_assurances_1/table_sinistre_details_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Table_Sinistre_Details.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Table_Sinistre_Details");
        }
...
/************************************************************************************************
 *     164004 characters generated by Talend Open Studio for Data Integration 
 *     on the 6 octobre 2022 à 12:12:56 GMT+01:00
 ************************************************************************************************/