...
package ami_assurances_1.table_contrat_details_0_1;
...
/**
 * Job: Table_Contrat_Details Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Table_Contrat_Details implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Table_Contrat_Details";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Table_Contrat_Details.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Table_Contrat_Details.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_AMI_ASSURANCES_1_Table_Contrat_Details = new byte[0];
    static byte[] commonByteArray_AMI_ASSURANCES_1_Table_Contrat_Details = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AMI_ASSURANCES_1_Table_Contrat_Details.length) {
				if(length < 1024 && commonByteArray_AMI_ASSURANCES_1_Table_Contrat_Details.length == 0) {
   					commonByteArray_AMI_ASSURANCES_1_Table_Contrat_Details = new byte[1024];
				} else {
   					commonByteArray_AMI_ASSURANCES_1_Table_Contrat_Details = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AMI_ASSURANCES_1_Table_Contrat_Details, 0, length);
			strReturn = new String(commonByteArray_AMI_ASSURANCES_1_Table_Contrat_Details, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AMI_ASSURANCES_1_Table_Contrat_Details) {
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("Contrat_Details");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("Contrat_Details");
}
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:EEW87Vz9NKxdJFiYgyj+7L9UMOq09cgApU8vBrhcwLE7FspC8hprdg==");
...
int count_tDBOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null, new String[]{"TABLE"})) {
                                    ...
                                    while(rsTable_tDBOutput_1.next()) {
                                        ...
                                        if(table_tDBOutput_1.equals(("Contrat_Details"))
                                ...
                                try(java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                    stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1 + "\"(\"NUMCNT\" VARCHAR(15)  default ' '  not null ,\"NUMAVT\" FLOAT4 default 0  not null ,\"NUMMAJ\" FLOAT4 default 0  not null ,\"CODGRNT\" VARCHAR(4)  default ' '  not null ,\"PRIMGRNT\" NUMERIC(12,3)  default 0  not null )");
                                }
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"NUMCNT\",\"NUMAVT\",\"NUMMAJ\",\"CODGRNT\",\"PRIMGRNT\") VALUES (?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:MwSRN+z2L3+flS+tHnta2/7rXWlh0MYrO2F0G8LVfyCtmL0=");
...
+"RI, \n  PRTB003.CORRECCE, \n  PRTB003.CORRECTE, \n  PRTB003.UPDATE_IDENT\nFROM PRTB003";
        	...
        	row1.NUMCNT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.NUMAVT = 0;
							} else {
		                          
            row1.NUMAVT = rs_tDBInput_1.getFloat(2);
            ...
            row1.NUMMAJ = rs_tDBInput_1.getFloat(3);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.NUMRISQ = rs_tDBInput_1.getFloat(4);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.CODGRNT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.ORDRGRNT = 0;
							} else {
		                          
            row1.ORDRGRNT = rs_tDBInput_1.getFloat(6);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.TYPEGRNT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.CODCOMM = null;
							} else {
	                         		
        	row1.CODCOMM = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.CODTAXE = null;
							} else {
	                         		
        	row1.CODTAXE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								row1.TYPPRIGRN = null;
							} else {
	                         		
        	row1.TYPPRIGRN = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.PRIMGRNT = 0;
							} else {
		                          
            row1.PRIMGRNT = rs_tDBInput_1.getFloat(11);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.TYPFRANCH = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 13) {
								row1.UNTFR = null;
							} else {
	                         		
        	row1.UNTFR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 14) {
								row1.NBUNITFR = 0;
							} else {
		                          
            row1.NBUNITFR = rs_tDBInput_1.getFloat(14);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.MINFRANCH = rs_tDBInput_1.getFloat(15);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.TYPLIMIT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 16, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 17) {
								row1.UNTLIMIT = null;
							} else {
	                         		
        	row1.UNTLIMIT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 17, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 18) {
								row1.NBUNITLM = 0;
							} else {
		                          
            row1.NBUNITLM = rs_tDBInput_1.getFloat(18);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.UNLIMIT2 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 19, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 20) {
								row1.TYPLIMIT2 = null;
							} else {
	                         		
        	row1.TYPLIMIT2 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 20, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 21) {
								row1.NBUNITLM2 = 0;
							} else {
		                          
            row1.NBUNITLM2 = rs_tDBInput_1.getFloat(21);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.TYPPRIMGR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 22, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 23) {
								row1.NBUNIPRI = 0;
							} else {
		                          
            row1.NBUNIPRI = rs_tDBInput_1.getFloat(23);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.CORRECCE = rs_tDBInput_1.getFloat(24);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.CORRECTE = rs_tDBInput_1.getFloat(25);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.UPDATE_IDENT = rs_tDBInput_1.getBigDecimal(26);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
...
// # Output table : 'row3'
row3_tmp.NUMCNT = row1.NUMCNT ;
row3_tmp.NUMAVT = row1.NUMAVT ;
row3_tmp.NUMMAJ = row1.NUMMAJ ;
row3_tmp.CODGRNT = row1.CODGRNT ;
row3_tmp.PRIMGRNT = row1.PRIMGRNT ;
row3 = row3_tmp;
// ###############################
...
} else {pstmt_tDBOutput_1.setString(1, row3.NUMCNT);
}

                    pstmt_tDBOutput_1.setFloat(2, row3.NUMAVT);

                    pstmt_tDBOutput_1.setFloat(3, row3.NUMMAJ);

                    if(row3.CODGRNT == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, row3.CODGRNT);
}

                    pstmt_tDBOutput_1.setFloat(5, row3.PRIMGRNT);
 ...
 */
    ...
    public static void main(String[] args){
        final Table_Contrat_Details Table_Contrat_DetailsClass = new Table_Contrat_Details();

        int exitCode = Table_Contrat_DetailsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Table_Contrat_Details.class.getClassLoader().getResourceAsStream("ami_assurances_1/table_contrat_details_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Table_Contrat_Details.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Table_Contrat_Details");
        }
...
/************************************************************************************************
 *     67380 characters generated by Talend Open Studio for Data Integration 
 *     on the 6 octobre 2022 à 12:12:50 GMT+01:00
 ************************************************************************************************/